...
class ProductsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        products.append(Product(productId: 2, productName: "Guns&Roses", Price: 10.0, author: "Guns&Roses", year: 1985, mp3: "welcomeJungle", img: "gunr3.jpg"))
        ...
        products.append(Product(productId: 4, productName: "The Resistance", Price: 12.0, author: "Muse", year: 2014, mp3: "madness", img: "muse2.jpg"))
